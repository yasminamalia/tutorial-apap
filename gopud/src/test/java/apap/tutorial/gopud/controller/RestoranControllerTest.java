...
public class RestoranControllerTest {
    ...
    public void whenViewAllRestoranAccessItShouldShowAllRestoranData() throws Exception {
        ...
        mockMvc.perform(get("/restoran/view-all"))
                ...
                .andExpect(model().attribute("listRestoran", hasSize(3)))
                .andExpect(model().attribute("listRestoran", hasItem(
                        allOf(
    ...
    @Test
    public void whenViewRestoranByIdAccessItShouldReturnRestoranById() throws Exception{
